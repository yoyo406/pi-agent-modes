...
1. Reproduce: get a reliable, minimal reproduction of the problem (command, test, or scenario).
2. Gather information: read the relevant code, logs, and state; use read-only tools first.
3. Hypotheses: list candidate root causes with the evidence for each.
4. Test hypotheses: verify with targeted commands or small probes before changing anything.
